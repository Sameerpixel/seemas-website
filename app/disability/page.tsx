        ...
        <div className="grid gap-10 xl:grid-cols-[1.6fr_0.9fr]">
          ...
          <div className="rounded-[3rem] border border-[#9fc9ec] bg-[#e3f0fb]/90 p-14 shadow-[0_20px_60px_rgba(0,0,0,0.05)] backdrop-blur-2xl">
            ...
            <div className="mt-10 space-y-8 text-[24px] leading-[2] text-[#4d4641]">
              ...
              <p>
                Dr. Seema has played a leading role in setting up inclusive
                education systems within mainstream schools, working extensively
                with school administrators, teachers, parents, and students.
                Her training programs and talks span a wide range of themes,
                including child development, classroom-based intervention
                strategies, and teacher support from preschool onwards.
              </p>

              <p>
                For students of all age groups, her work addresses life skills,
                study strategies, child safety, sexual health and hygiene, and
                social and emotional wellbeing, among others.
              </p>

              <p>
                She also conducts parent empowerment programs and supports
                teachers and families in developing and implementing
                Individualized Education Programs (IEPs)—both at school and at
                home—ensuring continuity of support across environments.
              </p>
